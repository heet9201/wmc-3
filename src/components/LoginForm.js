...
function LoginForm() {
    ...
    return (
        <>
            <div className="bg-rose-50 w-screen h-screen min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                    ...
                    <form className="mt-8 space-y-6" action="#" method="POST">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="text-sm">
                                ...
                                <a href="signin" className='ml-2 font-medium text-black hover:text-indigo-600'>Sign In</a>
                            </div>
                        </div>
